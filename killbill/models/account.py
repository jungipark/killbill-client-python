...
class Account(object):
    ...
    def __init__(self, account_id=None, name=None, first_name_length=None, external_key=None, email=None,
                 bill_cycle_day_local=None, currency=None, parent_account_id=None, is_payment_delegated_to_parent=False,
                 payment_method_id=None, reference_time=None, time_zone=None, address1=None, address2=None,
                 postal_code=None, company=None, city=None, state=None, country=None, locale=None, phone=None,
                 notes=None, is_migrated=False, account_balance=None, account_cba=None, audit_logs=None):  # noqa: E501
